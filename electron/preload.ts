...
const electronAPI = {
  ...
  updateConfig: (config: { apiKey?: string; apiProvider?: string; extractionModel?: string; solutionModel?: string; debuggingModel?: string; model?: string; language?: string; opacity?: number }) =>
